...
{
    public partial class InclinometerSenor : Form
    {
        #region 变量定义区
        ...
        public InclinometerSenor()
        {
            InitializeComponent();
        }

        private void InclinometerSenor_Load(object sender, EventArgs e)
        {
            ...
            timerAct.Interval = time_interval;
        ...
        private void InclinometerSenor_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        {
            timerAct.Interval = Convert.ToUInt16(textBox_time.Text);
            timerAct.Start();
        }
