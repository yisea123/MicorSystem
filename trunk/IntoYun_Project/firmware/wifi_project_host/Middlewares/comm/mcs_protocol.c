...
$Id: mcs_protocol.c 40486 2018-08-08 13:50:21Z tangmingfei2013@126.com $
...
******************************************************************************/
static uint8_t MCS_SearchCmd( MCS *pst_mcs, PFNCT_MCS* func );
...
static bool MCS_ActionExecuter( MCS* pst_mcs )
{
    ...
    if( MCS_SearchCmd(pst_mcs, &fptr ) == 0 ) 
    {
         goto exit;
    }
