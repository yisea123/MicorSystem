...
static INT8U u8_CrcHi = 0xFF;
static INT8U u8_CrcLo = 0xFF;
...
static const INT8U u8_CrcTabHi[] = {
...
static const INT8U u8_CrcTabLo[] = {
...
{
    INT8U u8_crch = 0xFF;      // initial high
    INT8U u8_crcl = 0xFF;      // initial low
    INT16U u16_idx;
...
static const INT32U u32_CrcTab[256] = {
...
void* MemCpy( void* pv_dst, const void* pv_src, INT32U u32_len )
{
   ...
   pu8_dst = (INT8U*)pv_dst;
   pu8_src = (INT8U*)pv_src;
