...
static const board_SpiInfo_t s_spi[BOARDDIV_SPI_NUM] =
{
  // SPI1
  {
    // SCK =  PA5
    {
      ...
      GPIO_PIN_5,
      {
        GPIO_MODE_AF_PP,GPIO_PULLUP,GPIO_SPEED_FREQ_HIGH, GPIO_AF5_SPI1
      },
      true
    },
    ...
    // MISO = PA6
    {
      ...
      GPIO_PIN_6,
      {
        GPIO_MODE_AF_PP,GPIO_PULLDOWN, GPIO_SPEED_FREQ_HIGH,GPIO_AF5_SPI1
      },
      true
    },
    ...
    // NSS =  PA4 (Not Slave Select; polarity inverted -> false)
    {
      ...
      GPIO_PIN_4,
      {
        GPIO_MODE_OUTPUT_PP,GPIO_PULLUP,GPIO_SPEED_FREQ_HIGH,NULL
      },
      false
    },
...
/*!
 * @brief Definition of I2C busses
 */
static const board_I2cInfo_t s_i2c[BOARDDIV_I2C_NUM] =
{
  // i2c for ILB
  {
    I2C1,
    // sda
    {
      ...
      GPIO_PIN_9,
      {
        GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF4_I2C1
      },
      true
    },
    // scl
  ...
  // i2c for other sensors
  {
    ...
    // sda
    {
      ...
      GPIO_PIN_11,
      {
        GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF4_I2C2
      },
      true
    },
    // scl
...

  {
    ...
    // sda
    {
      ...
      GPIO_PIN_9,
      {
        GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_AF4_I2C3
      },
      true
    },
    // scl
